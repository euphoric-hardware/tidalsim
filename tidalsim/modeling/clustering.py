...
def get_closest_sample_to_centroid(
    centroid: np.ndarray, matrix: np.ndarray, labels: np.ndarray, cluster_idx: int
) -> int:
...
def get_closest_samples_to_centroids(
    centroids: np.ndarray, samples: np.ndarray
