...
def main():
    ...
    parser.add_argument('--cache-warmup', action='store_true', help='Generate checkpoints for L1d warmup too')
    ...
    if args.cache_warmup:
        ...
        spike_cmd = get_spike_cmd(binary, args.n_harts, args.isa, debug_file=None, inst_log=True, commit_log=True, suppress_exit=False)
        ...
        with spike_trace_file.open('r') as f:
            ...
            mtr_ckpts = mtr_ckpts_from_inst_points(spike_trace_log, block_size=64, inst_points=inst_points)
